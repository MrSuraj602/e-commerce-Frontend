              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-2 text-gray-700 shadow-sm hover:border-indigo-300 hover:text-gray-900"
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 top-14 z-30 w-56 rounded-xl border border-gray-200 bg-white p-2 shadow-xl">
                      <button
                        type="button"
